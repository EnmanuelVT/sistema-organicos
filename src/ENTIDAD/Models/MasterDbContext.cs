...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdAuditoria).HasName("PK__Auditori__9644A3CE9FE8E165");
        ...
        {
            entity.HasKey(e => e.IdBitacora).HasName("PK__Bitacora__7E4268B0C507D5AD");
        ...
        {
            entity.HasKey(e => e.IdDocumento).HasName("PK__Document__5D2EE7E51D600A93");
        ...
        {
            entity.HasKey(e => e.IdEstado).HasName("PK__Estado_M__86989FB2784D88D3");

            entity.ToTable("Estado_Muestra");

            entity.HasIndex(e => e.Nombre, "UQ__Estado_M__72AFBCC61B700B04").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdHistorial).HasName("PK__Historia__76E6C5021723E7F4");
        ...
        {
            entity.HasKey(e => e.MstCodigo).HasName("PK__Muestra__800EDF4D00AEAD43");
        ...
        {
            entity.HasKey(e => e.IdNotificacion).HasName("PK__Notifica__8270F9A532EFD304");
        ...
        {
            entity.HasKey(e => e.IdParametro).HasName("PK__Parametr__3D24E325D2EE409F");
        ...
        {
            entity.HasKey(e => e.IdPrueba).HasName("PK__Prueba__328A457303F9EA03");
        ...
        {
            entity.HasKey(e => e.IdResultado).HasName("PK__Resultad__33A42B30FC4B3533");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol_Usua__6ABCB5E066C260B9");

            entity.ToTable("Rol_Usuario");

            entity.HasIndex(e => e.NombreRol, "UQ__Rol_Usua__673CB43536C2E89A").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdTipoDoc).HasName("PK__Tipo_Doc__B0A524EAA8A44FBA");

            entity.ToTable("Tipo_Documento");

            entity.HasIndex(e => e.Nombre, "UQ__Tipo_Doc__72AFBCC60951CF99").IsUnique();
        ...
        {
            entity.HasKey(e => e.TpmstId).HasName("PK__Tipo_Mue__3DB040A804E93572");

            entity.ToTable("Tipo_Muestra");

            entity.HasIndex(e => e.Nombre, "UQ__Tipo_Mue__72AFBCC60C441ABF").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsCedula).HasName("PK__Usuario__615FCA46B75A046E");

            entity.ToTable("Usuario");

            entity.HasIndex(e => e.Username, "UQ__Usuario__536C85E4D4F928BE").IsUnique();
