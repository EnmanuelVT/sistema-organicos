...
namespace DB.Migrations
{
    ...
    [Migration("20250829194910_HacerPruebaParametroUnoAUno")]
    partial class HacerPruebaParametroUnoAUno
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.ParametroNorma", b =>
                {
                    ...
                    b.Property<byte>("IdTipoMuestraNavigationTpmstId")
                        .HasColumnType("tinyint");
                    ...
                    b.HasIndex("IdTipoMuestraNavigationTpmstId");
            ...
            modelBuilder.Entity("Models.Prueba", b =>
                {
                    ...
                    b.Property<string>("IdMuestraNavigationMstCodigo")
                        .IsRequired()
                        .HasColumnType("varchar(30)");
                    ...
                    b.HasIndex("IdMuestraNavigationMstCodigo");
            ...
            modelBuilder.Entity("Models.ParametroNorma", b =>
                {
                    ...
                    b.HasOne("Models.TipoMuestra", "IdTipoMuestraNavigation")
                        .WithMany()
                        .HasForeignKey("IdTipoMuestraNavigationTpmstId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Models.Prueba", b =>
                {
                    b.HasOne("Models.Muestra", "IdMuestraNavigation")
                        .WithMany("Pruebas")
                        .HasForeignKey("IdMuestraNavigationMstCodigo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
