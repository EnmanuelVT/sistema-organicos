...
namespace DB.Migrations
{
    ...
    [Migration("20260114004656_UpdateSpsForTipoPrueba")]
    partial class UpdateSpsForTipoPrueba
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ENTIDAD.Models.EstadoDocumento", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdEstadoDocumento"));
                    ...
                    b.HasKey("IdEstadoDocumento")
                        .HasName("PK__Estado_D__5D9B2B2D1CBBE2F3");

                    b.HasIndex(new[] { "Nombre" }, "UQ__Estado_D__72AFBCC6E3D8D2B1")
                        .IsUnique();

                    b.ToTable("Estado_Documento", (string)null);
                });
            ...
            modelBuilder.Entity("Models.TipoMuestraTipoPrueba", b =>
                {
                    b.Property<byte>("TpmstId")
                        .HasColumnType("tinyint")
                        .HasColumnName("tpmst_id");
                    ...
                    b.HasKey("TpmstId", "TipoPruebaId")
                        .HasName("PK_Tipo_Muestra_Tipo_Prueba");

                    b.HasIndex("TipoPruebaId");

                    b.ToTable("Tipo_Muestra_Tipo_Prueba", (string)null);
                });

            modelBuilder.Entity("Models.TipoPrueba", b =>
                {
                    b.Property<int>("IdTipoPrueba")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id_tipo_prueba");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTipoPrueba"));
                    ...
                    b.HasKey("IdTipoPrueba")
                        .HasName("PK_Tipo_Prueba");

                    b.HasIndex(new[] { "Codigo" }, "UQ_Tipo_Prueba_codigo")
                        .IsUnique();

                    b.HasIndex(new[] { "Nombre" }, "UQ_Tipo_Prueba_nombre")
                        .IsUnique();

                    b.ToTable("Tipo_Prueba", (string)null);
                });
            ...
            modelBuilder.Entity("Models.Documento", b =>
                {
                    b.HasOne("ENTIDAD.Models.EstadoDocumento", "IdEstadoDocumentoNavigation")
                        .WithMany("Documentos")
            ...
            modelBuilder.Entity("Models.ParametroNorma", b =>
                {
                    b.HasOne("Models.TipoPrueba", "TipoPrueba")
            ...
            modelBuilder.Entity("Models.TipoMuestraTipoPrueba", b =>
                {
                    b.HasOne("Models.TipoPrueba", "TipoPrueba")
                        .WithMany("TipoMuestraTipoPruebas")
                        .HasForeignKey("TipoPruebaId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Models.TipoMuestra", b =>
                {
                    ...
                    b.Navigation("TipoMuestraTipoPruebas");
                });
